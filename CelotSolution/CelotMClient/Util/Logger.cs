...
namespace CelotMClient.Util
{
    ...
    public class Logger
    {
        ...
        {
            string sDirPath;
            sDirPath = System.Windows.Forms.Application.StartupPath + "\\LOGS_COMMON";
            ...
            if (logger == null)
            {
                ...
                if (logfile == null)
                {
                    logfile = Path.Combine(sDirPath,  String.Format("{0}.log",CelotUtility.GetCurrentTimeString("yyyy_MM_dd")));
                }
