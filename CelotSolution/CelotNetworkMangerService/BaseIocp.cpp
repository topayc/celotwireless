...
{
	BaseIocp *Owner = (BaseIocp*)parameter;
	Owner->WorkerThreadCallback();
	return 0;
}

BaseIocp::BaseIocp(VOID)
{
	mIocpHandle			= NULL;
...
BOOL BaseIocp::RegisterSocketToIocp(SOCKET socket, ULONG_PTR completionKey)
{
...
VOID BaseIocp::WorkerThreadCallback(VOID)
{
